...
<div class="col-sm-12">
    ...
    <div class="card">
        ...
        <div class="card-block">
            ...
            @endif
            <a class="btn btn-primary btn-sm" href="{{ route('treatment.add') }}">Add</a>
                ...
                <table id="order-table" class="table table-striped table-bordered nowrap">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $val->photo }}</td>
                            <td>
                                <form action="{{ route('treatment.destroy', $val->id) }}" id="delete_data{{ $val->id }}" method="post">
                                    {{ csrf_field() }}
                                    {{ method_field('DELETE') }}
                                    <div class="btn-group " role="group" data-toggle="tooltip">
                                    <a class="btn btn-success btn-mini" href="{{ route('treatment.show', $val->id) }}">                                        
