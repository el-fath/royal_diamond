                    ...
                    <!-- Authentication card start -->
                        ...
                        <form class="md-float-material form-material">
                            <div class="text-center">
                                <img src="{{ url('assets/admin') }}/assets/images/logo.png" alt="logo.png">
                            </div>
                            <div class="auth-box card">
                                <div class="card-block">
                                    ...
                                    <div class="row">
                                        ...
                                        <!-- <div class="col-md-2">
                                            <img src="{{ url('assets/admin') }}/assets/images/auth/Logo-small-bottom.png" alt="small-logo.png">
                                        </div> -->
                                    </div>
                                </div>
                            </div>
...
<script type="text/javascript" src="{{ url('assets/admin') }}/assets/js/common-pages.js"></script>
</body>
