                        ...
                        <div class="auth-box card">
                            <div class="card-block">
                                <div class="row m-b-20">
                                    <div class="col-md-12">
                                        <h3 class="text-center">Sign In For Admin</h3>
                                    </div>
                                </div>
                                @if (session('alert'))
                                ...
                                @endif
                                <form class="md-float-material form-material" action="{{ route('authentification') }}" method="POST">
                                    {{ csrf_field() }}
                                    <div class="form-group form-primary">
                                        <input type="text" name="username" class="form-control" required="" value="{{ session('username') }}">
...
<!-- i18next.min.js -->
<script type="text/javascript" src="{{ url('public/assets/admin') }}/bower_components/i18next/js/i18next.min.js"></script>
<script type="text/javascript" src="{{ url('public/assets/admin') }}/bower_components/i18next-xhr-backend/js/i18nextXHRBackend.min.js"></script>
<script type="text/javascript" src="{{ url('public/assets/admin') }}/bower_components/i18next-browser-languagedetector/js/i18nextBrowserLanguageDetector.min.js"></script>
<script type="text/javascript" src="{{ url('public/assets/admin') }}/bower_components/jquery-i18next/js/jquery-i18next.min.js"></script>
<script type="text/javascript" src="{{ url('public/assets/admin') }}/assets/js/common-pages.js"></script>
</body>
