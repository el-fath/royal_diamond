        ...
        <div class="swiper-wrapper">
            ...
            @foreach($slide as $row)
                <div class="swiper-slide">
                    <!-- Full screen section -->
                    <section class="full-screen fw-main-row" style="background-image: url({{$row->PhotoPath}});">
                        <div class="fw-container centered-container tar">
                            <div class="container tar fw-col-xs-12 fw-col-sm-6 fw-col-md-5">
                                ...
                                <p>{{$row->content}}</p>
                                <a href="{{ url('public/assets/main') }}/javascript:void(0);" class="button-style1"><span>CHECK OUT</span></a>
                            </div>
                        </div>
                    </section>
