...
@section('content')
    ...
    <section class="fw-main-row pt40">
        <div class="fw-container">
            <h2 class="heading-decor pb20">{{$team->name}}</h2>
            <div class="fw-row">
                <div class="fw-col-lg-10 fw-col-lg-offset-1">
                    <a data-fancybox="gallery" href="{{ $team->PhotoPath }}">
                        <img src="{{ $team->PhotoPath }}" alt="{{ $team->name }}" class="img-responsive" style="max-height: 500px;width: 100%;object-fit: cover">
                    </a>
                    <h2 class="pt30 pb10">{{ $team->name }} ({{ $team->position }})</h2>
